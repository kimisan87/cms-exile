...
<head>
	...
	<!-- For all browsers -->
	<link rel="stylesheet" href="{{ base_url }}themes/login/assets/login/css/reset3860.css?v=1">
	<link rel="stylesheet" href="{{ base_url }}themes/login/assets/login/css/style3860.css?v=1">
	<link rel="stylesheet" href="{{ base_url }}themes/login/assets/login/css/colors3860.css?v=1">
	<link rel="stylesheet" media="print" href="{{ base_url }}themes/login/assets/login/css/print3860.css?v=1">
	<!-- For progressively larger displays -->
	<link rel="stylesheet" media="only all and (min-width: 480px)" href="{{ base_url }}themes/login/assets/login/css/4803860.css?v=1">
	<link rel="stylesheet" media="only all and (min-width: 768px)" href="{{ base_url }}themes/login/assets/login/css/7683860.css?v=1">
	<link rel="stylesheet" media="only all and (min-width: 992px)" href="{{ base_url }}themes/login/assets/login/css/9923860.css?v=1">
	<link rel="stylesheet" media="only all and (min-width: 1200px)" href="{{ base_url }}themes/login/assets/login/css/12003860.css?v=1">
	<!-- For Retina displays -->
	<link rel="stylesheet" media="only all and (-webkit-min-device-pixel-ratio: 1.5), only screen and (-o-min-device-pixel-ratio: 3/2), only screen and (min-device-pixel-ratio: 1.5)" href="{{ base_url }}themes/login/assets/login/css/2x3860.css?v=1">

	<!-- Additional styles -->
	<link rel="stylesheet" href="{{ base_url }}themes/login/assets/login/css/styles/form3860.css?v=1">
	<link rel="stylesheet" href="{{ base_url }}themes/login/assets/login/css/styles/switches3860.css?v=1">

	<!-- Login pages styles -->
	<link rel="stylesheet" media="screen" href="{{ base_url }}themes/login/assets/login/css/login3860.css?v=1">

	<!-- JavaScript at bottom except for Modernizr -->
	<script src="{{ base_url }}themes/login/assets/login/js/libs/modernizr.custom.js"></script>

	<!-- For Modern Browsers -->
	<link rel="shortcut icon" href="{{ base_url }}themes/login/assets/login/img/favicons/favicon.png">
	<!-- For everything else -->
	<link rel="shortcut icon" href="{{ base_url }}themes/login/assets/login/img/favicons/favicon.ico">
	<!-- For retina screens -->
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ base_url }}themes/login/assets/login/img/favicons/apple-touch-icon-retina.png">
	<!-- For iPad 1-->
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ base_url }}themes/login/assets/login/img/favicons/apple-touch-icon-ipad.png">
	<!-- For iPhone 3G, iPod Touch and Android -->
	<link rel="apple-touch-icon-precomposed" href="{{ base_url }}themes/login/assets/login/img/favicons/apple-touch-icon.png">
	...
	<link rel="apple-touch-startup-image" href="{{ base_url }}themes/login/assets/login/img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
	<link rel="apple-touch-startup-image" href="{{ base_url }}themes/login/assets/login/img/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
	<link rel="apple-touch-startup-image" href="{{ base_url }}themes/login/assets/login/img/splash/iphone.png" media="screen and (max-device-width: 320px)">
...
<body>
	...
	<!-- Scripts -->
	<script src="{{ base_url }}themes/login/assets/login/js/libs/jquery-1.7.2.min.js"></script>
	<script src="{{ base_url }}themes/login/assets/login/js/setup.js"></script>

	<!-- Template functions -->
	<script src="{{ base_url }}themes/login/assets/login/js/developr.input.js"></script>
	<script src="{{ base_url }}themes/login/assets/login/js/developr.message.js"></script>
	<script src="{{ base_url }}themes/login/assets/login/js/developr.notify.js"></script>
	<script src="{{ base_url }}themes/login/assets/login/js/developr.tooltip.js"></script>
	...
	<script>
			...
			$('#form-login').submit(function(event)
			{
				...
				else
				{
					...
					/*-  This is where you may do your AJAX call, for instance:*/
					  $.ajax('<?php echo site_url()?>main/login_do', {
					  type:"POST",
					  		data: {
					  			identity:	login,
					  			password:	pass
					  		...
					  		success: function(data)
					  		{
					  			if (data)
					  			{
					  				document.location.href = '<?php echo site_url()?>main/management';
					  			}
					  			else
					  			{
					  				formWrapper.clearMessages();
		...
		notify('Welcome', 'This CMS is still on ALPHA stage any bugs please report to<br> Hakimi@exile-studio.com', {
			autoClose: false,
			delay: 2500
